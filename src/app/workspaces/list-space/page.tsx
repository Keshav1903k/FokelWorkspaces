...
export default function ListSpacePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#FAF8F5]">
      <section className="relative bg-[#121316] text-white pt-24 pb-16 md:pt-28 md:pb-20 text-center border-b border-[#2E2F34] overflow-hidden">
        <div className="relative z-10 container mx-auto px-6 max-w-5xl flex flex-col items-center justify-center">
          ...
          <h1 className="text-3xl md:text-5xl font-bold text-white tracking-tight leading-tight mb-4 max-w-3xl text-center">
            List your commercial property with Fokel
          </h1>
          <p className="text-[#9E9EA5] text-sm max-w-2xl leading-relaxed font-normal text-center">
