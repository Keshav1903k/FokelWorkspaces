...
export default function SupportServicesPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      {/* CTA Bottom Banner */}
      <section className="py-20 bg-[#FAF8F5] border-t border-[#E3DDD3]">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="bg-[#18191C] text-white border border-[#2E2F34] rounded-sm p-8 sm:p-12 md:p-14 relative overflow-hidden text-center flex flex-col items-center">
