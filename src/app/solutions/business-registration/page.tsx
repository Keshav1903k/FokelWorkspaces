...
export default function BusinessRegistrationPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      {/* Hero Banner */}
      <section className="bg-[#18191C] py-16 md:py-24 text-center relative overflow-hidden -mt-6">
        ...
        <div className="relative z-10 container mx-auto px-6 max-w-5xl flex flex-col items-center">
          ...
          <p className="text-white/80 text-xs sm:text-base max-w-2xl leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {REGISTRATION_SERVICES.map((option, idx) => (
              <motion.div
                ...
                className="bg-white border border-[#E8EDF2] rounded-2xl overflow-hidden shadow-[0_6px_24px_rgba(0,0,0,0.03)] hover:shadow-[0_12px_36px_rgba(0,0,0,0.06)] hover:border-[#E3DDD3] transition-all duration-300 flex flex-col h-full group"
              >
                {/* Visual Image */}
                ...
                <div className="p-6 flex flex-col flex-1 gap-4">
                  <div className="flex items-center gap-2">
                    <div className="w-8 h-8 rounded-lg bg-[#FAF8F5] text-primary flex items-center justify-center border border-[#E3DDD3]">
      ...
      {/* FAQs Section */}
      <section className="pt-16 pb-8 bg-slate-50 border-t border-[#E8EDF2]">
      ...
      {/* CTA Bottom Banner */}
      <section className="w-full mt-6 sm:mt-8 mb-6 sm:mb-8 bg-[#18191C] text-white border-y border-[#2E2F34] py-8 sm:py-10 relative overflow-hidden text-center flex flex-col items-center">
        <div className="container mx-auto px-6 max-w-7xl relative z-10 flex flex-col items-center">
          ...
          <p className="text-white/80 text-xs sm:text-sm max-w-xl mb-8 leading-relaxed">
          ...
          <button
            onClick={handleGetStarted}
            className="bg-primary hover:bg-[#A93E1B] text-white px-7 py-3.5 rounded-sm text-xs font-semibold transition-all shadow-md cursor-pointer"
          >
